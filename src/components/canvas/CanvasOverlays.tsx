...
export function CanvasOverlays({
    ...
    return (
        <div className="absolute inset-0 pointer-events-none">
            {/* Selection Box */}
            <SelectionBox box={selectionBox} canvasTransform={canvasTransform} />
            ...
            <div className="absolute top-6 left-6 flex flex-col gap-3 z-10 pointer-events-none">
                ...
                <div className="flex items-center gap-3">
                    <div className="px-3 py-1.5 rounded-lg backdrop-blur-xl shadow-sm border transaction-colors duration-200"
                        style={{ backgroundColor: 'var(--color-surface)', borderColor: 'var(--color-border)' }}>
                        <div className="flex items-center gap-2">
                            <div className="w-1.5 h-1.5 rounded-full bg-green-500 shadow-[0_0_8px_rgba(34,197,94,0.4)] animate-pulse" />
                            <span className="text-[10px] font-bold uppercase tracking-widest" style={{ color: 'var(--color-text)' }}>Online</span>
                        </div>
                    </div>
