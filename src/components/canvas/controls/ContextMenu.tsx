    ...
    >
      ...
      >
        <button
          onClick={
            actions.find(
              (a): a is ContextMenuAction => "id" in a && a.id === "duplicate",
            )?.action
          }
            ...
            return (
              <div key={action.id}>
                ...
                <button
                  ...
                  onMouseLeave={(e) => {
                    e.currentTarget.style.backgroundColor = "transparent";
                    e.currentTarget.style.opacity = action.disabled
                      ? "0.4"
                      : "1";
                  }}
                >
